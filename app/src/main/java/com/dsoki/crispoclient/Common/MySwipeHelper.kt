...
abstract class MySwipeHelper (context : Context,
                              ...
                              internal var buttonWidth:Int):ItemTouchHelper
                         ...
                         private val listener:IMyButtonCallBack)
    {
        ...
        fun onDrew(c:Canvas,rectF: RectF,pos:Int)
        {
            val p =Paint()
            p.color=color
            c.drawRect(rectF,p)
      ...
      translationx: Float)
    {
        ...
        for (button in buffer)
        {
            ...
            button.onDrew(c,RectF(left,itemView.top.toFloat(),right,itemView.bottom.toFloat()),pos)
            right =left
        }
    }
}